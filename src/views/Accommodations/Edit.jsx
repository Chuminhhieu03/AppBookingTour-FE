    ...
    <Row>
      <Col span={24}>
        <MainCard
          ...
          secondary={
            <Space>
              <Button type="primary" shape="round" icon={<CheckOutlined />} onClick={() => onEditAccommodation(accommodation)}>
                Lưu
              </Button>
              <Button type="primary" href={`/admin/service/accommodation/display/${id}`} shape="round" icon={<CloseOutlined />}>
                Thoát
              </Button>
            </Space>
          }
        >
          <Row gutter={[24, 24]}>
            ...
            <Col span={8}>
              <span>Tên</span>
              <Input value={accommodation.name} onChange={(e) => setAccommodation({ ...accommodation, name: e.target.value })} />
            </Col>
            <Col span={8}>
              <span>Loại</span>
              <Select
            ...
            <Col span={8}>
              ...
              <Input value={accommodation.address} onChange={(e) => setAccommodation({ ...accommodation, address: e.target.value })} />
            </Col>
            <Col span={8}>
            ...
            <Col span={8} className="d-flex align-items-center gap-2">
              <span>Hạng sao</span>
              <Rate value={accommodation.starRating} onChange={(val) => setAccommodation({ ...accommodation, starRating: val })} />
            </Col>
            <Col span={24}>
