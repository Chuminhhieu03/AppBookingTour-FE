...
export default function FavouriteDestinations() {
    ...
    return (
        <div style={{ background: "#E6F0FA", padding: "50px 10%" }}>
            <div style={{ textAlign: "center" }}>
                <h2 style={{ fontWeight: "bold", color: "#004E9A" }}>
                    ĐIỂM ĐẾN YÊU THÍCH
                </h2>
                ...
                <p style={{ fontSize: 16, color: "#444" }}>
                    Hãy chọn một điểm đến du lịch nổi tiếng dưới đây để khám phá các chuyến đi độc quyền
                    của chúng tôi với mức giá vô cùng hợp lý.
                </p>
            </div>
