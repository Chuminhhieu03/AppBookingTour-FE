...
const ItemStatisticsByRevenue = () => {
    ...
    const handleExportExcel = async () => {
        ...
        try {
            ...
            const response = await statisticsAPI.exportItemStatisticsByRevenue(params);
            ...
            link.download = `ThongKe_${itemTypeName}_DoanhThu_Tu_${startDateFormatted}_Den_${endDateFormatted}.xlsx`;
